    ...
    <div className='columns is-centered' id='about'>
      <div className='column is-10'>
        ...
        <div className='content'>
          <p>
            I'm a full-stack engineer with {yearsOfExperience} years of experience building software across finance, healthcare, logistics, and social platforms. I've worked with teams of all sizes, from scrappy startups to large enterprises, and I love the challenge of turning complex problems into elegant solutions.
          </p>
          <p>
